 ...
 * @returns {TResult}
 */
export function $use<TValue, TResult>(value: TValue, fn: (value: TValue) => TResult): TResult {
  return fn(value);
}
 ...
 */
export function $ifexists<TValue>(value: TValue | null | undefined, fn: (value: TValue) => void): void {
